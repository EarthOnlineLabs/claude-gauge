...
export function Privacy() {
  ...
  const ROWS = [
    ...
    { icon: "coin", aura: "green", title: t("Costs you nothing", "零额度消耗"), text: t("Refreshes in the background and never spends a token of your subscription.", "后台静默刷新，永不花掉你订阅里的一个 token。") },
  ...
  return (
    <section id="privacy" className="cg-section cg-band">
      <div className="cg-shell">
        ...
        />
        <div className="cg-grid cg-grid--4 cg-priv-cards">
          {ROWS.map((r, i) => (
